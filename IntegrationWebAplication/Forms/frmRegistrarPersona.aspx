<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/PageMaster.master" Inherits="IntegrationWebAplication.Forms_frmRegistrarPersona" Title="REGISTRAR PERSONA" Codebehind="frmRegistrarPersona.aspx.vb" %>
...
<asp:Content ID="contenido" ContentPlaceHolderID="contenido" runat="server">
    <table style="width: 650px; height: 134px" cellspacing="0" cellpadding="0" align="center"
        ...
        <tr>
            <td align="left" colspan="4" style="height: 16px; text-align: justify;">
                <span style="color: #ff0000; font-size:14px; font-family: Verdana"><strong>Antes de realizar un nuevo
                    registro, por favor verificar si la persona ya existe y editar sus datos si 
                es necesario.</strong></span>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td style="width: 189px; text-align: left;" align="right">
                ...
                </asp:Button><asp:Button ID="btnLimpiar" runat="server" Width="110px" Text="Limpiar"
                    CssClass="Boton"></asp:Button><font face="Verdana"></font>
            </td>
        </tr>
        <tr>
            <td align="left" style="width: 131px">
