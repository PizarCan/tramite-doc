...
Public Class crptAcuEstadistica
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IntegrationWebAplication.crptAcuEstadistica.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrptAcuEstadistica
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crptAcuEstadistica = New crptAcuEstadistica()
        rpt.Site = Me.Site
        Return rpt
    End Function
