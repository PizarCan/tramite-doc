<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/PageMaster.master" Inherits="IntegrationWebAplication.Forms_RegDocArea" Title="ENVIO DE DOCUMENTOS" Codebehind="RegDocArea.aspx.vb" %>
                ...
                <table border="0">
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:DropDownList ID="cboNumero" Visible="false" runat="server" Width="52px" AutoPostBack="True">
                            </asp:DropDownList>
