...
Public Class RptDocDiario
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IntegrationWebAplication.RptDocDiario.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptDocDiario
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptDocDiario = New RptDocDiario()
        rpt.Site = Me.Site
        Return rpt
    End Function
