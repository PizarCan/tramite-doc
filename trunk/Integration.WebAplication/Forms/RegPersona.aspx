<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RegPersona.aspx.vb" Inherits="Forms_RegPersona" %>
        ...
        <tr>
            <td align="left" colspan="4" style="height: 24px; text-align: justify;">
                <span style="color: #ff0000; font-family: Verdana"><strong>Antes de realizar un nuevo
                    registro, por favor verificar bien si ya existe (buscar persona), ya que se están
                    registrando personas duplicadas, la cual ocasionan problemas en el SEUSS.</strong></span>
            </td>
        </tr>
        <tr>
