...
Public Class crpDocDiarios
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IntegrationWebAplication.crpDocDiarios.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrpDocDiarios
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpDocDiarios = New crpDocDiarios()
        rpt.Site = Me.Site
        Return rpt
    End Function
