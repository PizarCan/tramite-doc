...
Public Class rptTDDocBusca
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IntegrationWebAplication.rptTDDocBusca.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptTDDocBusca
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptTDDocBusca = New rptTDDocBusca()
        rpt.Site = Me.Site
        Return rpt
    End Function
