...
Public Class rptTDAcuerdos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IntegrationWebAplication.rptTDAcuerdos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptTDAcuerdos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptTDAcuerdos = New rptTDAcuerdos()
        rpt.Site = Me.Site
        Return rpt
    End Function
